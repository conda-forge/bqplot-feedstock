About bqplot-feedstock
======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/bqplot-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3754&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/bqplot-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `bqplot` can be installed with `conda`:
...
It is possible to list all of the versions of `bqplot` available on your platform with `conda`:
...
```
mamba search bqplot --channel conda-forge
```
...
mamba repoquery search bqplot --channel conda-forge

# List packages depending on `bqplot`:
mamba repoquery whoneeds bqplot --channel conda-forge

# List dependencies of `bqplot`:
mamba repoquery depends bqplot --channel conda-forge
```
